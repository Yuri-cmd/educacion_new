...
$ano_actual = date("Y");
$hijos = "SELECT COUNT(*) as total FROM estudiante_contacto AS est_cont 
...
$hijos = $conexion->query($hijos);

if ($hijos) {
    $fila = $hijos->fetch_assoc();
    $total_hijos = $fila['total'];
}
?>
...
<div class="wrapper">
   <?php include 'funcionalidades/fragment/header-padre.php' ?>
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua animate__animated animate__fadeInDown">
                        ...
                        <a href="<?=URL::to('supervisor/mensajes')?>" class="small-box-footer">MÃ¡s informaciÃ³n <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-purple animate__animated animate__fadeInDown">
                        ...
                        <a href="<?=URL::to('supervisor/familiar')?>" class="small-box-footer">MÃ¡s informaciÃ³n  <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow animate__animated animate__fadeInDown">
                        <div class="inner">
                            <h3><?php echo $total_hijos ?></h3>
                            <p></p><h4><strong>Hijos</strong></h4><h4><p></p>
                            </h4></div>
                        <div class="icon">
                            <i class="ion ion-person-add" style="color:white"></i>
                        </div>
                        <a href="<?=URL::to('supervisor/hijos')?>" class="small-box-footer">MÃ¡s informaciÃ³n <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red animate__animated animate__fadeInDown">
                        ...
                        <a href="javascript:void(0)" class="small-box-footer">MÃ¡s informaciÃ³n <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
            </div>
