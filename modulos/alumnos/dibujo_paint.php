...
$id_actividad = Tools::decrypt(actividad_id);

$sql ="select * from actividad_curso where actividad_id ='$id_actividad'";

$conteni = $conexion->query($sql)->fetch_assoc();
...
<input type="hidden" value="<?= $conteni['id_curso'] ?>" id="curso_id">
                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            ...
                            <a href="<?=URL::to('alumno/actividad/'.actividad_id)?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <main>
                        <div class="left-block">
                            ...
                            <div class="buttons">
                                ...
                                <button id="clear_2" type="button"><i class="fa fa-refresh"></i> Limpiar</button>
...
<script>
    ...
    window.onload = function () {
        ...
        var clear2Button = document.getElementById('clear_2');
