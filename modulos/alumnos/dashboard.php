...
$sql ="SELECT * FROM view_estudiantes_matriculados WHERE id_usuario = '$usuario' and periodo = '".date('Y')."'";
$data_user = $conexion->query($sql)->fetch_assoc();
...
if ($temp = $dataMt->fetch_assoc()){
    $sql = "SELECT doce.*,perf.*,us.*
FROM curso_docente AS curs_doc  
JOIN docentes AS doce ON doce.docente_id = curs_doc.docente_id
JOIN perfiles AS perf ON doce.id_perfil = perf.perfil_id
LEFT JOIN usuarios AS us ON doce.id_usuario = us.usuario_id
 WHERE curs_doc.nivel = '{$temp['nivel_educativo']}' AND curs_doc.grado= '{$temp['grado']}' AND curs_doc.seccion = '{$temp['seccion']}'";
//echo $sql;
    $listaMisDocen = $conexion->query($sql);
}
    ...
    <div class="content-wrapper" style="min-height: 850px;height: 93vh;overflow: auto;">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua animate__animated animate__fadeInDown">
                        ...
                        <a href="<?=URL::to('alumno/mensajes')?>" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-purple animate__animated animate__fadeInDown">
                        <div class="inner">
                            <h3 style="color: rgba(255,255,255,0)">0</h3>
                            <p></p><h4><strong>Cursos</strong></h4><h4><p></p>
                            </h4></div>
                        <div class="icon">
                            <i class="fa fa-book" style="color:white"></i>
                        </div>
                        <a href="<?=URL::to('alumno/cursos')?>" class="small-box-footer">Más información  <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow animate__animated animate__fadeInDown">
                        <div class="inner">
                            <h3 style="color: rgba(255,255,255,0)">2</h3>
                            <p></p><h4><strong>Blog</strong></h4><h4><p></p>
                            </h4></div>
                        <div class="icon">
                            <i class="ion ion-archive" style="color:white"></i>
                        </div>
                        <a href="#blog-psicologia" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red animate__animated animate__fadeInDown">
                        <div class="inner">
                            <h3>3</h3>
                            <p></p><h4><strong>Mis Medios</strong></h4><h4><p></p>
                            </h4></div>
                        <div class="icon">
                            <i class="fa fa-folder-open-o" style="color:white"></i>
                        </div>
                        <a href="<?=URL::to('alumno/galeria')?>" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
            </div>
            ...
            <div class="row">
                ...
                <section class="col-lg-9 connectedSortable ui-sortable">
                    <div class="box box-success">
                        <div class="box-header ui-sortable-handle" style="cursor: move;">
                            <div class="col-lg-6">
                                <h2><i class="fa fa-envelope-open-o"></i>&nbsp;Horario <small> </small></h2>
                            </div>
                            <div class="col-lg-12"><hr></div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body" style="">
                            <img style="display: block;margin: auto;max-width: 100%;" src="<?=URL::to('images/Institucion/Horarios/'.$data_user['horario'])?>">

                            <br>
                            <br>
                            <h4><strong>Link de las clases </strong></h4>
                            <div>
                                <ol>
                                    <?php
                                    foreach ($listaMisDocen as $item_doc){
                                        echo '<li><a href="'.$item_doc['link'].'" target="_blank">'.$item_doc['primer_nombre'].' '.$item_doc['segundo_nombre'].' '.$item_doc['apellido_paterno'].' '.$item_doc['apellido_materno'].'</a></li>';
                                    }
                ...
                <section id="blog-psicologia" class="col-lg-8 connectedSortable ui-sortable">
                    <div class="box box-success">
                        <div class="box-header ui-sortable-handle" style="cursor: move;">
                            <div class="col-lg-6">
                        ...
                        <div class="box-body">
                            ...
                            foreach ($lista_post as $post){  ?>
                                <div class="col-md-6">
                                    <div class="box-post-edu" onclick="view_post('<?=Tools::encrypt($post['blo_id'])?>')" style="margin-bottom: 5px">
                                        <div class="box-post-img">
                                            <?php
                                            if (strlen($post['blo_imagen'])>0){?>
                                                <img style="max-height: 198px;display: block;margin: auto;max-width: 100%;" src="<?=URL::to('images/Blog/'.$post['blo_imagen'])?>">
                                            <?php   }
                                            ?>
                ...
                <section class="col-lg-4 connectedSortable ui-sortable">
                    <div class="box box-success">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body" style="overflow: auto;max-height: 600px;">
                            <?php
...
<script>
        function view_post(post){
            location.href =URL+"/alumno/post/"+post
        }
