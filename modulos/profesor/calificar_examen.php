...
join matricula_aperturas ma on cur_doc.id_apertura = ma.matr_id
...
$sql ="SELECT * FROM cuestionario WHERE id_actividad = '$id_actividad'";
$idExamen = 0;
if ($row__ = $conexion->query($sql)->fetch_assoc()){
    $idExamen = $row__['cuestionario_id'];
}
...
FROM
  ...
  LEFT JOIN examen_iniciado AS exa_ini 
    ON exa_ini.id_estudiante = estu_mat.estu_id 
    AND exa_ini.id_actividad =  '$id_actividad'
                ...
                <div class="box-body" id="conten-primary">
                    <div class="row" style="padding: 10px;min-height: 527px;">
                        <div class="col-md-12 text-center" style="margin-bottom: 40px">
                            <h2 style="font-weight: bold;">Calificar Examen</h2>
                        ...
                        <div class="col-md-12" >
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Ver Examen</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                ...
                                foreach ($listaAlumnos as $item){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?=is_null($item['iniciado_id'])?'<span class="label label-danger">Examen no Entregado</span>':'<span class="label label-success">Examen Entregado</span>' ?></td>
                                        ...
                                        <td class="text-center">
                                            <?php
                                            if (!is_null($item['iniciado_id'])){?>
                                                <a href="<?=URL::to('profesores/verexamen/'.Tools::encrypt($item['iniciado_id']))?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                            <?php   }
                                            ?>
