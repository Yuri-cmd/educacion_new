        ...
        <section class="content" id="contenedor-primario">
            ...
            <div class="box">
                ...
                <div class="box-body" id="conten-primary">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class=" col-md-7">
                                        <input v-model="datConf.duracion_minutos" @keypress="onlyNumber" required  type="text"
                                               class="form-control "   >
                                    </div>
                    ...
                    <div id="modal-registro-pregunta" class="modal fade" role="dialog"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div id="cont-pregunta-body1"></div>
                                                <div class="box-body" id="conten-primary">
                                                    <div class="row" style="padding: 10px;min-height: 300px;">
                    ...
                    <div class="modal" id="modal-new-preg" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input id="texto_respuesta" class="form-control">
                                </div>
                                <div class="modal-footer">
        ...
        const APP = new Vue({
            ...
            methods:{
                ...
                setRegisterNe(){
                    ...
                    CKEDITOR.instances.example.setData("")
                    this.respuestas=[]
                    this.opd= false;
                },
                setDataE(data){
                    ...
                    console.log(data)
                    CKEDITOR.instances.example.setData(data.cuerp)
                ...
                getData(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: URL+"/ajax/actividadcurso",
                        data: {tipo:'quiz',cod: $("#quiz_id").val()},
                        success: function (resp) {
                            // console.log(resp)
                            resp = JSON.parse(resp);
