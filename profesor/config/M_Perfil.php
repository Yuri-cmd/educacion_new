      ...
      <div class="modal-content">
          ...
          <div class="modal-body ualto">
             ...
             <div class="form-group col-xs-12 col-md-12 col-lg-4">
               ...
               <input type="password" class="form-control" name="txtclave" id="ppass"  pattern="[A-z0-9 ].{1,}" title="Ingrese solo letras">
             </div>
             <div class="form-group col-xs-12 col-md-12 col-lg-12">
               <label>LINK DE CLASES:</label>
               <input class="form-control" name="plink" id="plink">
             </div>
          </div>
...
<script type="text/javascript">
  ...
  $('#frmajax1').submit(function(e){
      ...
      plink = $.trim($('#plink').val());
      $.ajax({
            url:"functions/Usuarios/Usuarios.php",
            type: "POST",
            datatype:"json",
            data:  {perid:perid,ppass:ppass,pnomup:pnomup,plink:plink,opcion:opcion},
