<style type="text/css">
 ...
 <div class="modal fade" id="M_Blog"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog ">
       <div class="modal-content">
           <div class="modal-header bg-green-gradient">
             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
               <span aria-hidden="true">&times;</span></button>
               <h3 align="center" id="myModalLabel"><i class="fa fa-image"></i>&nbsp;Agregar Contenido</h3>
           </div>
             ...
             <div class="form-group col-xs-12 col-md-12 col-lg-12">
              ...
              <div class="form-group col-xs-12 col-md-12 col-lg-12">
               <label>CONTENIDO:</label>
                <textarea  class="form-control text-uppercase" rows="11" id="vmensaje" pattern="^([a-zA-Z ])[a-zA-Z0-9-_–\. ]+{1,60}$" placeholder="Detalle del mensaje" required> </textarea>
              </div>
