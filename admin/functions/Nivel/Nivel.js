function eliminarNivelNow(nivel) {
    $.ajax({
        url: "functions/Nivel/Nivel.php",
        type: "POST",
        data:  {opcion:96,nivel},
               ...
               columnDefs: [
                   {
                       ...
                       render:function (data, type, row, meta) {
                           return "<button onclick='eliminarNivelNow("+data+")' class='btn btn-sm btn-danger'><i class='fa fa-times'></i></button>";
                       }
                   }
               ]
             });
