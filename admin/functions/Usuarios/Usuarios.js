function eliminarEstUsers(user) {
    $.ajax({
        type:"POST",
...
$(document).ready(function() {
               ...
               columnDefs: [
                   {
                       ...
                       render:function (data, type, row, meta) {
                           return "<button onclick='eliminarEstUsers("+data+")' class='btn btn-sm btn-danger'><i class='fa fa-times'></i></button>";
                       }
                   }
               ]
             });
  ...
  $.ajax({
         ...
         type: "POST",
         datatype:"json",
         data:  {opcion:opcion,instid:instid,ptdoc:ptdoc,pnumd:pnumd,pnomb1:pnomb1,pnomb2:pnomb2,pape1:pape1,pape2:pape2,pfnac:pfnac,pemail:pemail,ptele:ptele,selrol:selrol,pgene:pgene,pdirec:pdirec,psico:psico},
         success: function(data) {
           listar();
